...
router.route("/:id/update-academic-info").patch(UserController_1.academicUpdate);
router.route("/:id/update-location-info").patch(UserController_1.updateLocation);
router.route("/:id/update-religion-info").patch(UserController_1.religiousUpdate);
router.route("/:id/update-profession-info").patch(UserController_1.professionalUpdate);
router.route("/:id/update-bio-info").patch(UserController_1.bioUpdate);
